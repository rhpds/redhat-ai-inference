...
A hands-on workshop experience taking attendees through the full inference lifecycle from model selection to large scale deployment.

**Owner:** taylorjordanNC
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/redhat-ai-inference`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/redhat-ai-inference
   ```
3. `cd redhat-ai-inference`
